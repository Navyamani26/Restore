...
function isBaskestItem(product: Product | Item) : product is Item{
    ...
    endpoints: (builder) => ({
        ...
        addBasketItem: builder.mutation<Basket,{product: Product | Item,quantity: number}>({
            query: ({product, quantity }) => {
                const productId = isBaskestItem(product) ? product.productId : product.id
                return{
                ...
                const patchResult = dispatch(
                    basketApi.util.updateQueryData('fetchBasket',undefined, (draft)=>{
                       ...
                       if(!isNewBasket){
                            ...
                            else draft.items.push(isBaskestItem(product) 
