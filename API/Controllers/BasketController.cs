...
public class BasketController(StoreContext context) : BasicApiController
{

    [HttpGet]
    public async Task<ActionResult<BasketDtos>> GetBasket()
    {
        var basket = await RetriveBakset();
    ...
    public async Task<ActionResult> RemoveBasketItem(int productId, int quantity)
    {
        ...
        return BadRequest("Problem while removing the item in the basket");
    ...
    private async Task<Basket?> RetriveBakset()
    {
